# Architecture Decision Records for AREX

This document logs safety-critical and system design decisions made during the architecture and execution of AREX.
...
### Rationale
* **Synchronized Changes**: Changes to API specifications (like `shared/openapi/arex.yaml`) can be refactored on both client and server in a single pull request, reducing integration delays.
